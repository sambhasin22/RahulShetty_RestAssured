...
public class GetCourceWithPOJO1 {

	public static void main(String[] args) throws InterruptedException {
	
		
		String code =
		"https://rahulshettyacademy.com/getCourse.php?code=4/xwEl6yfzM1Xt2iicdC3oOOkEuvxPkMAFxBY3Y9Tqni_ZD4VKOp9BviOFh0N9wBLGKgFkSBN5pfe2rzIVUgi_cU8&scope=email+openid+https://www.googleapis.com/auth/userinfo.email&authuser=0&prompt=none";
